...
@interface ChoosePhotoPresenter ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, VPImageCropperDelegate>

@end

@implementation ChoosePhotoPresenter
...
- (void)showOptions
{
    ...
    = [[UIActionSheet alloc] initWithTitle:nil
                    ...
                    destructiveButtonTitle:nil
                         otherButtonTitles:@"从相机拍照",@"从相册选择", nil];
...
{
    [self.delegate choosePhotoDidFinished:editedImage];
    [cropperViewController dismissViewControllerAnimated:YES completion:nil];
}

- (void)imageCropperDidCancel:(VPImageCropperViewController *)cropperViewController
{
    [self.delegate choosePhotoDidFinished:nil];
    [cropperViewController dismissViewControllerAnimated:YES completion:nil];
}
...
-(void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    [picker dismissViewControllerAnimated:YES completion:^() {
        ...
        if (self.needCrop) {
            ...
            = [[VPImageCropperViewController alloc] initWithImage:portraitImg
                                                        cropFrame:CGRectMake(0, 100.0f, width, width)
                                                  limitScaleRatio:3.0];
            ...
            [self.delegate choosePhotoDidFinished:portraitImg];
        }
    }];
}
